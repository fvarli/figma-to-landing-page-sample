...
<section class="cta-section">
    <div class="cta-overlay"></div> <!-- Karanlık Overlay -->
    <div class="text-white cta-area">
        <h2 class="cta-title">Gemak Grup ile Tanışın: Geleceğinizi Güçlendirin!</h2>
        <p class="cta-description">
            50 yılı aşkın tecrübemizle, gemi ve çelik yapı endüstrisinde global başarı hikayelerine imza atıyoruz.
            Projelerinize değer katacak bir iş ortağı arıyorsanız, şimdi bizimle iletişime geçin!
        </p>
